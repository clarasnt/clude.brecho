...
categorias[4].addEventListener("mouseover", function(){
    categorias[4].setAttribute("style", "font-size:150px ; opacity: 1; background-image: linear-gradient(to left, transparent, white);")
})

categorias[4].addEventListener("mouseout", function(){
    categorias[4].setAttribute("style", "font-size:130px ; opacity: 1; background-image: linear-gradient(to left, transparent, transparent);")
})

categorias[5].addEventListener("mouseover", function(){
    categorias[5].setAttribute("style", "font-size:150px ; opacity: 1; background-image: linear-gradient(to left, transparent, white);")
})

categorias[5].addEventListener("mouseout", function(){
    categorias[5].setAttribute("style", "font-size:130px ; opacity: 1; background-image: linear-gradient(to left, transparent, transparent);")
})

categorias[6].addEventListener("mouseover", function(){
    categorias[6].setAttribute("style", "font-size:150px ; opacity: 1; background-image: linear-gradient(to left, transparent, white);")
})

categorias[6].addEventListener("mouseout", function(){
    categorias[6].setAttribute("style", "font-size:130px ; opacity: 1; background-image: linear-gradient(to left, transparent, transparent);")
})
